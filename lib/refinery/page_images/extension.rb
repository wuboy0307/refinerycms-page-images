  ...
  module PageImages
    module Extension
        ...
        module_eval do
          def images_attributes=(data)
            ...
            data.each do |i, image_data|
              image_page_id, image_id, caption, tag, part_title, link_url =
                  image_data.values_at('image_page_id', 'id', 'caption', "tag", "part_title", "link_url")
      ...
      module InstanceMethods
        ...
        def link_url_for_image_index(index)
          self.image_pages[index].try(:link_url).presence || ""
        end
      end
    end
  end
